export interface Review {
  ...
  title: string;
  body: string;
  product: 'Rose Epsom Salt' | 'Lavender Epsom Salt';
}
...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    body: 'Gave the Rose Epsom Salt to my mother and she would not stop talking about it. The petals in the salt are a lovely touch. Wish the jar was bigger!',
    product: 'Rose Epsom Salt',
  },
];
